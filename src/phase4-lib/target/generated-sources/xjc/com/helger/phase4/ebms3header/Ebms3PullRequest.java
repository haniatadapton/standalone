...
/**
 * <p>Java class for PullRequest complex type</p>.
 * 
...
public class Ebms3PullRequest implements Serializable, IExplicitlyCloneable
{
    ...
    public boolean equals(final Object o) {
        ...
        final Ebms3PullRequest rhs = ((Ebms3PullRequest) o);
    ...
    @Override
    public int hashCode() {
        return new HashCodeGenerator(this).append(any).append(mpc).append(otherAttributes).getHashCode();
    }
    ...
    public String toString() {
        return new ToStringGenerator(this).append("any", any).append("mpc", mpc).append("otherAttributes", otherAttributes).getToString();
    }
    ...
    @ReturnsMutableCopy
    @Override
    public Ebms3PullRequest clone() {
        Ebms3PullRequest ret = new Ebms3PullRequest();
        cloneTo(ret);
        return ret;
    }
