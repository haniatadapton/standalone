...
public final class AS4MimeMessageHelper
{
  ...
  @Nonnull
  public static com.helger.phase4.messaging.mime.AS4MimeMessage generateMimeMessage (@Nonnull final ESoapVersion eSoapVersion,
                                                                                     ...
                                                                                     @Nullable final ICommonsList <WSS4JAttachment> aEncryptedAttachments) throws MessagingException
  {
    ...
    // Build main message
    final com.helger.phase4.messaging.mime.AS4MimeMessage aMsg = new AS4MimeMessage((Session) null, bIsRepeatable);
