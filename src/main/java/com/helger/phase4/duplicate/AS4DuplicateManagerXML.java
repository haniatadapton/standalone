 ...
 */
@ThreadSafe
public class AS4DuplicateManagerXML extends AbstractPhotonMapBasedWALDAO <com.helger.phase4.duplicate.IAS4DuplicateItem, com.helger.phase4.duplicate.AS4DuplicateItem>
                                    implements
        IAS4DuplicateManager
{
  public AS4DuplicateManagerXML (@Nullable final String sFilename) throws DAOException
  {
    super (com.helger.phase4.duplicate.AS4DuplicateItem.class, sFilename);
  }
  ...
  public ICommonsList <String> evictAllItemsBefore (@Nonnull final OffsetDateTime aRefDT)
  {
    ...
    final ICommonsList <String> aEvictItems = getAllMapped (x -> x.getDateTime ().isBefore (aRefDT),
                                                            com.helger.phase4.duplicate.IAS4DuplicateItem::getMessageID);
