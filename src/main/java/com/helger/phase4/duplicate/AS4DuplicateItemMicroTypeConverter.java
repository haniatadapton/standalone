...
/**
 * Micro type converter for class {@link com.helger.phase4.duplicate.AS4DuplicateItem}.
 *
 * @author Philip Helger
 */
public final class AS4DuplicateItemMicroTypeConverter implements IMicroTypeConverter <com.helger.phase4.duplicate.AS4DuplicateItem>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.duplicate.AS4DuplicateItem aValue,
  ...
  public com.helger.phase4.duplicate.AS4DuplicateItem convertToNative (@Nonnull final IMicroElement aElement)
  {
