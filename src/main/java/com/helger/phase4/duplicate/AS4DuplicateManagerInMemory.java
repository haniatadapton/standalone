...
public class AS4DuplicateManagerInMemory implements IAS4DuplicateManager
{
  ...
  @GuardedBy ("m_aRWLock")
  private final ICommonsMap <String, com.helger.phase4.duplicate.AS4DuplicateItem> m_aMap = new CommonsHashMap <> ();
                                     ...
                                     @Nullable final String sPModeID)
  {
    ...
    final com.helger.phase4.duplicate.AS4DuplicateItem aItem = new AS4DuplicateItem(sMessageID, sProfileID, sPModeID);
  ...
  @Nullable
  public com.helger.phase4.duplicate.IAS4DuplicateItem findFirst (@Nonnull final Predicate <? super com.helger.phase4.duplicate.IAS4DuplicateItem> aFilter)
  {
    return m_aRWLock.readLockedGet ( () -> CollectionHelper.findFirst (m_aMap.values (), aFilter));
  }

  @Nullable
  public com.helger.phase4.duplicate.IAS4DuplicateItem getItemOfMessageID (@Nullable final String sMessageID)
  {
    if (StringHelper.hasNoText (sMessageID))
      return null;
