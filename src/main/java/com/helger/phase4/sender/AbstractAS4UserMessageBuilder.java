        ...
        AbstractAS4MessageBuilder<IMPLTYPE>
{
   ...
   * consumer internally.
   *
   * @return {@link com.helger.phase4.sender.EAS4UserMessageSendResult#SUCCESS} only if all parameters
   *         are correct, HTTP transmission was successful and if a positive AS4
   *         Receipt was returned. Never <code>null</code>.
   * @since 0.13.0
   */
  @Nonnull
  public final com.helger.phase4.sender.EAS4UserMessageSendResult sendMessageAndCheckForReceipt ()
  {
   ...
   */
  @Nonnull
  public final com.helger.phase4.sender.EAS4UserMessageSendResult sendMessageAndCheckForReceipt (@Nullable final Consumer <? super Phase4Exception> aExceptionConsumer)
  {
    ...
    try
    {
      ...
      if (sendMessage ().isFailure ())
      {
        ...
        return com.helger.phase4.sender.EAS4UserMessageSendResult.INVALID_PARAMETERS;
      }
      ...
      if (aSignalMsg == null)
      {
        ...
        return com.helger.phase4.sender.EAS4UserMessageSendResult.NO_SIGNAL_MESSAGE_RECEIVED;
      }
      ...
      if (aSignalMsg.hasErrorEntries ())
      {
        ...
        return com.helger.phase4.sender.EAS4UserMessageSendResult.AS4_ERROR_MESSAGE_RECEIVED;
      }

      if (aSignalMsg.getReceipt () != null)
      {
        // A receipt was returned - this is deemed success
        return com.helger.phase4.sender.EAS4UserMessageSendResult.SUCCESS;
      }
      ...
      return com.helger.phase4.sender.EAS4UserMessageSendResult.INVALID_SIGNAL_MESSAGE_RECEIVED;
    }
