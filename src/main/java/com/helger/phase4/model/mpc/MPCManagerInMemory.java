...
public class MPCManagerInMemory implements IMPCManager
{
  ...
  @GuardedBy ("m_aRWLock")
  private final ICommonsMap <String, com.helger.phase4.model.mpc.MPC> m_aMap = new CommonsHashMap <> ();
  ...
  public final void createMPC (@Nonnull final com.helger.phase4.model.mpc.MPC aMPC)
  {
