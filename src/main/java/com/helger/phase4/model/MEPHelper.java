...
public final class MEPHelper
{
  ...
  private static boolean _isValidResponseType (@Nonnull final com.helger.phase4.model.EMEP eMEP,
  ...
  public static boolean isValidResponseTypeLeg1 (@Nonnull final com.helger.phase4.model.EMEP eMEP,
                                                 @Nonnull final EMEPBinding eMEPBinding,
                                                 @Nonnull final EAS4MessageType eMsgType)
  {
