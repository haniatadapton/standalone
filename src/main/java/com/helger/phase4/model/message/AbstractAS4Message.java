                                         ...
                                         IGenericImplTrait <IMPLTYPE>
{
  ...
  private final com.helger.phase4.model.message.EAS4MessageType m_eMsgType;
  private final String m_sMessagingID;
  protected final Ebms3Messaging m_aMessaging = new Ebms3Messaging ();

  public AbstractAS4Message (@Nonnull final ESoapVersion eSoapVersion, @Nonnull final com.helger.phase4.model.message.EAS4MessageType eMsgType)
  {
