...
public final class PModePropertyJsonConverter
{
  ...
  @Nonnull
  public static IJsonObject convertToJson (@Nonnull final com.helger.phase4.model.pmode.leg.PModeProperty aValue)
  {
  ...
  @Nonnull
  public static com.helger.phase4.model.pmode.leg.PModeProperty convertToNative (@Nonnull final IJsonObject aElement)
  {
