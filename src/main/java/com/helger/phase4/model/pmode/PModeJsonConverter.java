...
/**
 * JSON converter for objects of class {@link com.helger.phase4.model.pmode.PMode}.
 *
...
public final class PModeJsonConverter
{
  ...
  @Nonnull
  public static com.helger.phase4.model.pmode.PMode convertToNative (@Nonnull final IJsonObject aElement)
  {
    final IJsonObject aInit = aElement.getAsObject (ELEMENT_INITIATOR);
    final com.helger.phase4.model.pmode.PModeParty aInitiator = aInit == null ? null : PModePartyJsonConverter.convertToNative (aInit);
