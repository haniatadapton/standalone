...
/**
 * XML converter for objects of class {@link com.helger.phase4.model.pmode.leg.PModeLegErrorHandling}.
 *
 * @author Philip Helger
 */
public class PModeLegErrorHandlingMicroTypeConverter extends AbstractPModeMicroTypeConverter <com.helger.phase4.model.pmode.leg.PModeLegErrorHandling>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.model.pmode.leg.PModeLegErrorHandling aValue,
  ...
  @Nonnull
  public com.helger.phase4.model.pmode.leg.PModeLegErrorHandling convertToNative (@Nonnull final IMicroElement aElement)
  {
    final com.helger.phase4.model.pmode.leg.PModeAddressList aReceiverAddresses = MicroTypeConverter.convertToNative (aElement.getFirstChildElement (ELEMENT_REPORT_RECEIVER_ERRORS_TO),
                                                                                    com.helger.phase4.model.pmode.leg.PModeAddressList.class);
    final com.helger.phase4.model.pmode.leg.PModeAddressList aSenderAddresses = MicroTypeConverter.convertToNative (aElement.getFirstChildElement (ELEMENT_REPORT_SENDER_ERRORS_TO),
