...
/**
 * XML converter for objects of class {@link com.helger.phase4.model.pmode.PModePayloadService}.
 * 
 * @author Philip Helger
 */
public final class PModePayloadServiceMicroTypeConverter implements IMicroTypeConverter <com.helger.phase4.model.pmode.PModePayloadService>
{
  private static final IMicroQName ATTR_COMPRESSION_MODE = new MicroQName ("CompressionMode");

  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.model.pmode.PModePayloadService aValue,
  ...
  @Nonnull
  public com.helger.phase4.model.pmode.PModePayloadService convertToNative (@Nonnull final IMicroElement aElement)
  {
