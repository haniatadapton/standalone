...
/**
 * XML converter for {@link com.helger.phase4.model.pmode.leg.PModeLeg}.
 * 
 * @author Philip Helger
 */
public class PModeLegMicroTypeConverter extends AbstractPModeMicroTypeConverter <com.helger.phase4.model.pmode.leg.PModeLeg>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.model.pmode.leg.PModeLeg aValue,
  ...
  @Nonnull
  public com.helger.phase4.model.pmode.leg.PModeLeg convertToNative (@Nonnull final IMicroElement aElement)
  {
    final com.helger.phase4.model.pmode.leg.PModeLegProtocol aProtocol = MicroTypeConverter.convertToNative (aElement.getFirstChildElement (ELEMENT_PROTOCOL),
    ...
    final com.helger.phase4.model.pmode.leg.PModeLegErrorHandling aErrorHandling = MicroTypeConverter.convertToNative (aElement.getFirstChildElement (ELEMENT_ERROR_HANDLING),
                                                                                     PModeLegErrorHandling.class);
    final com.helger.phase4.model.pmode.leg.PModeLegReliability aReliability = MicroTypeConverter.convertToNative (aElement.getFirstChildElement (ELEMENT_RELIABILITY),
                                                                                 PModeLegReliability.class);
    final com.helger.phase4.model.pmode.leg.PModeLegSecurity aSecurity = MicroTypeConverter.convertToNative (aElement.getFirstChildElement (ELEMENT_SECURITY),
