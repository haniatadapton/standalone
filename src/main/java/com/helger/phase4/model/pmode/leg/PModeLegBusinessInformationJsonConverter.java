...
/**
 * JSON converter for objects of class {@link com.helger.phase4.model.pmode.leg.PModeLegBusinessInformation}.
 *
...
public final class PModeLegBusinessInformationJsonConverter
{
  ...
  @Nonnull
  public static IJsonObject convertToJson (@Nonnull final com.helger.phase4.model.pmode.leg.PModeLegBusinessInformation aValue)
  {
    ...
    if (aValue.properties ().isNotEmpty ())
      ret.addJson (PROPERTIES,
                   new JsonArray ().addAllMapped (aValue.properties ().values (),
                                                  com.helger.phase4.model.pmode.leg.PModePropertyJsonConverter::convertToJson));
    if (aValue.payloadProfiles ().isNotEmpty ())
      ret.addJson (PAYLOAD_PROFILE,
                   new JsonArray ().addAllMapped (aValue.payloadProfiles ().values (),
                                                  com.helger.phase4.model.pmode.leg.PModePayloadProfileJsonConverter::convertToJson));
  ...
  @Nonnull
  public static com.helger.phase4.model.pmode.leg.PModeLegBusinessInformation convertToNative (@Nonnull final IJsonObject aElement)
  {
