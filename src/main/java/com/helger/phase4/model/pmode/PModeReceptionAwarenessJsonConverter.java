...
/**
 * JSON converter for objects of class {@link com.helger.phase4.model.pmode.PModeReceptionAwareness}.
 *
...
public class PModeReceptionAwarenessJsonConverter
{
  ...
  @Nonnull
  public static IJsonObject convertToJson (@Nonnull final com.helger.phase4.model.pmode.PModeReceptionAwareness aValue)
  {
  ...
  @Nonnull
  public static com.helger.phase4.model.pmode.PModeReceptionAwareness convertToNative (final IJsonObject aElement)
  {
    final ETriState eReceptionAwareness = com.helger.phase4.model.pmode.AbstractPModeMicroTypeConverter.getTriState (aElement.getAsString (RECEPTION_AWARENESS),
                                                                                       com.helger.phase4.model.pmode.PModeReceptionAwareness.DEFAULT_RECEPTION_AWARENESS);
    final ETriState eRetry = com.helger.phase4.model.pmode.AbstractPModeMicroTypeConverter.getTriState (aElement.getAsString (RETRY),
                                                                          com.helger.phase4.model.pmode.PModeReceptionAwareness.DEFAULT_RETRY);
    final int nMaxRetries = aElement.getAsInt (MAX_RETRIES, com.helger.phase4.model.pmode.PModeReceptionAwareness.DEFAULT_MAX_RETRIES);
