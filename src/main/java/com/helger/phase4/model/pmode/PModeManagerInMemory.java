 ...
 */
@ThreadSafe
public class PModeManagerInMemory implements com.helger.phase4.model.pmode.IPModeManager
{
  private static final Logger LOGGER = LoggerFactory.getLogger (PModeManagerInMemory.class);

  private final SimpleReadWriteLock m_aRWLock = new SimpleReadWriteLock ();
  @GuardedBy ("m_aRWLock")
  private final ICommonsMap <String, com.helger.phase4.model.pmode.PMode> m_aMap = new CommonsHashMap <> ();
  ...
  @Nonnull
  public EChange updatePMode (@Nonnull final com.helger.phase4.model.pmode.IPMode aNewPMode)
  {
    ValueEnforcer.notNull (aNewPMode, "PMode");
    _validatePMode (aNewPMode);

    final com.helger.phase4.model.pmode.PMode aExistingPMode = getOfID (aNewPMode.getID ());
  ...
  @Nullable
  public com.helger.phase4.model.pmode.IPMode getPModeOfID (@Nullable final String sID)
  {
    return getOfID (sID);
  }

  @Nullable
  public com.helger.phase4.model.pmode.IPMode findFirst (@Nonnull final Predicate <? super com.helger.phase4.model.pmode.IPMode> aFilter)
  {
