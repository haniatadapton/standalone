...
public class PModeLegBusinessInformation implements Serializable
{
   ...
   */
  private final ICommonsOrderedMap <String, com.helger.phase4.model.pmode.leg.PModeProperty> m_aProperties = new CommonsLinkedHashMap <> ();

  /**
   * This parameter allows for specifying some constraint or profile on the
   * payload. It specifies a list of payload parts.
   */
  private final ICommonsOrderedMap <String, com.helger.phase4.model.pmode.leg.PModePayloadProfile> m_aPayloadProfiles = new CommonsLinkedHashMap <> ();
  ...
  public PModeLegBusinessInformation (@Nullable final String sServiceValue,
                                      ...
                                      @Nullable final ICommonsOrderedMap <String, com.helger.phase4.model.pmode.leg.PModeProperty> aProperties,
                                      @Nullable final ICommonsOrderedMap <String, com.helger.phase4.model.pmode.leg.PModePayloadProfile> aPayloadProfiles,
  ...
  public final ICommonsOrderedMap <String, com.helger.phase4.model.pmode.leg.PModeProperty> properties ()
  {
  ...
  @Nonnull
  @ReturnsMutableObject
  public final ICommonsOrderedMap <String, com.helger.phase4.model.pmode.leg.PModePayloadProfile> payloadProfiles ()
  {
