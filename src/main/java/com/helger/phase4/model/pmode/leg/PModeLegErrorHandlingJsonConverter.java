...
/**
 * JSON converter for objects of class {@link com.helger.phase4.model.pmode.leg.PModeLegErrorHandling}.
 *
...
public final class PModeLegErrorHandlingJsonConverter
{
  ...
  @Nonnull
  public static IJsonObject convertToJson (@Nonnull final com.helger.phase4.model.pmode.leg.PModeLegErrorHandling aValue)
  {
    final IJsonObject ret = new JsonObject ();
    if (aValue.hasReportSenderErrorsTo ())
      ret.addJson (REPORT_SENDER_ERRORS_TO,
                   com.helger.phase4.model.pmode.leg.PModeAddressListJsonConverter.convertToJson (aValue.getReportSenderErrorsTo ()));
    if (aValue.hasReportReceiverErrorsTo ())
      ret.addJson (REPORT_RECEIVER_ERRORS_TO,
                   com.helger.phase4.model.pmode.leg.PModeAddressListJsonConverter.convertToJson (aValue.getReportReceiverErrorsTo ()));
  ...
  @Nonnull
  public static com.helger.phase4.model.pmode.leg.PModeLegErrorHandling convertToNative (@Nonnull final IJsonObject aElement)
  {
    final IJsonArray aSender = aElement.getAsArray (REPORT_SENDER_ERRORS_TO);
    final com.helger.phase4.model.pmode.leg.PModeAddressList aSenderAddresses = aSender == null ? null : com.helger.phase4.model.pmode.leg.PModeAddressListJsonConverter.convertToNative (
                                                                                                                      aSender);
