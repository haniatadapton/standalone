...
/**
 * XML converter for objects of class {@link com.helger.phase4.model.pmode.leg.PModeProperty}.
 *
 * @author Philip Helger
 */
public class PModePropertyMicroTypeConverter extends AbstractPModeMicroTypeConverter <com.helger.phase4.model.pmode.leg.PModeProperty>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.model.pmode.leg.PModeProperty aValue,
  ...
  @Nonnull
  public com.helger.phase4.model.pmode.leg.PModeProperty convertToNative (@Nonnull final IMicroElement aElement)
  {
    ...
    final EMandatory eMandatory = EMandatory.valueOf (aElement.getAttributeValueAsBool (ATTR_MANDATORY,
                                                                                        com.helger.phase4.model.pmode.leg.PModeProperty.DEFAULT_MANDATORY));
