...
/**
 * Interface for a manager for {@link com.helger.phase4.model.pmode.PMode} objects.
 *
...
public interface IPModeManager
{
   ...
   */
  void createPMode (@Nonnull com.helger.phase4.model.pmode.PMode aPMode);
   ...
   */
  @Nonnull
  EChange updatePMode (@Nonnull com.helger.phase4.model.pmode.IPMode aPMode);
   ...
   */
  @Nullable
  com.helger.phase4.model.pmode.IPMode findFirst (@Nonnull Predicate <? super com.helger.phase4.model.pmode.IPMode> aFilter);
   ...
   */
  @Nullable
  default com.helger.phase4.model.pmode.IPMode getPModeOfServiceAndAction (@Nullable final String sService, @Nullable final String sAction)
  {
    return findFirst (x -> {
   ...
   */
  @Nonnull
  static Predicate <com.helger.phase4.model.pmode.IPMode> getPModeFilter (@Nonnull final String sID,
                                                                          @Nullable final com.helger.phase4.model.pmode.PModeParty aInitiator,
                                                                          @Nullable final com.helger.phase4.model.pmode.PModeParty aResponder)
  {
   ...
   */
  @Nullable
  com.helger.phase4.model.pmode.IPMode getPModeOfID (@Nullable String sID);
   ...
   */
  @Nonnull
  ICommonsList <com.helger.phase4.model.pmode.IPMode> getAll ();
   ...
   */
  default void validatePMode (@Nullable final com.helger.phase4.model.pmode.IPMode aPMode) throws PModeValidationException
  {
    ...
    final com.helger.phase4.model.pmode.PModeParty aInitiator = aPMode.getInitiator ();
    if (aInitiator != null)
    {
      // INITIATOR PARTY_ID
