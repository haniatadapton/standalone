...
/**
 * XML converter for objects of class {@link com.helger.phase4.model.pmode.leg.PModeLegBusinessInformation}.
 *
 * @author Philip Helger
 */
public class PModeLegBusinessInformationMicroTypeConverter extends
                                                           AbstractPModeMicroTypeConverter <com.helger.phase4.model.pmode.leg.PModeLegBusinessInformation>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.model.pmode.leg.PModeLegBusinessInformation aValue,
  ...
  @Nonnull
  public com.helger.phase4.model.pmode.leg.PModeLegBusinessInformation convertToNative (@Nonnull final IMicroElement aElement)
  {
    ...
    final ICommonsOrderedMap <String, com.helger.phase4.model.pmode.leg.PModeProperty> aProperties = new CommonsLinkedHashMap <> ();
    for (final IMicroElement aPropertyElement : aElement.getAllChildElements (ELEMENT_PROPERTIES))
    {
      final com.helger.phase4.model.pmode.leg.PModeProperty aProperty = MicroTypeConverter.convertToNative (aPropertyElement, PModeProperty.class);
      aProperties.put (aProperty.getName (), aProperty);
    }

    final ICommonsOrderedMap <String, com.helger.phase4.model.pmode.leg.PModePayloadProfile> aPayloadProfiles = new CommonsLinkedHashMap <> ();
    for (final IMicroElement aPayloadElement : aElement.getAllChildElements (ELEMENT_PAYLOAD_PROFILE))
    {
      final com.helger.phase4.model.pmode.leg.PModePayloadProfile aPayloadProfile = MicroTypeConverter.convertToNative (aPayloadElement,
