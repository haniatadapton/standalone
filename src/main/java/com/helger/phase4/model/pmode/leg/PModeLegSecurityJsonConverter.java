...
/**
 * JSON converter for objects of class {@link com.helger.phase4.model.pmode.leg.PModeLegSecurity}.
 *
...
public final class PModeLegSecurityJsonConverter
{
  ...
  /**
   * Convert the provided {@link com.helger.phase4.model.pmode.leg.PModeLegSecurity} object to a JSON object. The
   ...
   */
  @Nonnull
  public static IJsonObject convertToJson (@Nonnull final com.helger.phase4.model.pmode.leg.PModeLegSecurity aValue)
  {
  ...
  /**
   * Convert the provided JSON to a {@link com.helger.phase4.model.pmode.leg.PModeLegSecurity} object.
   *
   * @param aElement
   *        The JSON object to be converted. May not be <code>null</code>.
   * @return A non-<code>null</code> {@link com.helger.phase4.model.pmode.leg.PModeLegSecurity}
   * @throws IllegalStateException
   *         In case of an unsupported value
   */
  @Nonnull
  public static com.helger.phase4.model.pmode.leg.PModeLegSecurity convertToNative (@Nonnull final IJsonObject aElement)
  {
    ...
    final ETriState eUsernameTokenDigest = AbstractPModeMicroTypeConverter.getTriState (aElement.getAsString (ATTR_USERNAME_TOKEN_DIGEST),
                                                                                        com.helger.phase4.model.pmode.leg.PModeLegSecurity.DEFAULT_USERNAME_TOKEN_DIGEST);
    final ETriState eUsernameTokenNonce = AbstractPModeMicroTypeConverter.getTriState (aElement.getAsString (ATTR_USERNAME_TOKEN_NONCE),
                                                                                       com.helger.phase4.model.pmode.leg.PModeLegSecurity.DEFAULT_USERNAME_TOKEN_NONCE);
    final ETriState eUsernameTokenCreated = AbstractPModeMicroTypeConverter.getTriState (aElement.getAsString (ATTR_USERNAME_TOKEN_CREATED),
                                                                                         com.helger.phase4.model.pmode.leg.PModeLegSecurity.DEFAULT_USERNAME_TOKEN_CREATED);
    final ETriState ePModeAuthorize = AbstractPModeMicroTypeConverter.getTriState (aElement.getAsString (ATTR_PMODE_AUTHORIZE),
                                                                                   com.helger.phase4.model.pmode.leg.PModeLegSecurity.DEFAULT_PMODE_AUTHORIZE);
    final ETriState eSendReceipt = AbstractPModeMicroTypeConverter.getTriState (aElement.getAsString (ATTR_SEND_RECEIPT),
                                                                                com.helger.phase4.model.pmode.leg.PModeLegSecurity.DEFAULT_SEND_RECEIPT);
    final String sSendReceiptReplyPattern = aElement.getAsString (ATTR_SEND_RECEIPT_REPLY_PATTERN);
    final com.helger.phase4.model.pmode.leg.EPModeSendReceiptReplyPattern eSendReceiptReplyPattern = EPModeSendReceiptReplyPattern.getFromIDOrNull (sSendReceiptReplyPattern);
    ...
    final ETriState eSendReceiptNonRepudiation = AbstractPModeMicroTypeConverter.getTriState (aElement.getAsString (ATTR_SEND_RECEIPT_NON_REPUDIATION),
                                                                                              com.helger.phase4.model.pmode.leg.PModeLegSecurity.DEFAULT_SEND_RECEIPT_NON_REPUDIATION);
