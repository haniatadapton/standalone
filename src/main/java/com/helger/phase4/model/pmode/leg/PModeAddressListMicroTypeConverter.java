...
/**
 * XML converter for {@link com.helger.phase4.model.pmode.leg.PModeAddressList} objects.
 *
 * @author Philip Helger
 */
public class PModeAddressListMicroTypeConverter extends AbstractPModeMicroTypeConverter <com.helger.phase4.model.pmode.leg.PModeAddressList>
{
  private static final String ELEMENT_ADDRESSES = "Addresses";

  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.model.pmode.leg.PModeAddressList aValue,
  ...
  @Nonnull
  public com.helger.phase4.model.pmode.leg.PModeAddressList convertToNative (@Nonnull final IMicroElement aElement)
  {
