...
/**
 * Persisting manager for {@link com.helger.phase4.model.pmode.PMode} objects.
 *
 * @author Philip Helger
 */
@ThreadSafe
public class PModeManagerXML extends AbstractPhotonMapBasedWALDAO <com.helger.phase4.model.pmode.IPMode, com.helger.phase4.model.pmode.PMode> implements com.helger.phase4.model.pmode.IPModeManager
{
  ...
  {
    super (com.helger.phase4.model.pmode.PMode.class, sFilename);
  }

  private void _validatePMode (@Nonnull final com.helger.phase4.model.pmode.IPMode aPMode)
  {
    try
    {
  ...
  private void _createPModeLocked (@Nonnull final com.helger.phase4.model.pmode.PMode aPMode)
  {
    internalCreateItem (aPMode);
    AuditHelper.onAuditCreateSuccess (com.helger.phase4.model.pmode.PMode.OT, aPMode.getID ());

    if (LOGGER.isDebugEnabled ())
      LOGGER.debug ("Created PMode with ID '" + aPMode.getID () + "'");
  }

  public void createPMode (@Nonnull final com.helger.phase4.model.pmode.PMode aPMode)
  {
  ...
  @Nonnull
  public EChange updatePMode (@Nonnull final com.helger.phase4.model.pmode.IPMode aPMode)
  {
    ValueEnforcer.notNull (aPMode, "PMode");
    _validatePMode (aPMode);

    final com.helger.phase4.model.pmode.PMode aExistingPMode = getOfID (aPMode.getID ());
    if (aExistingPMode == null)
    {
      AuditHelper.onAuditModifyFailure (com.helger.phase4.model.pmode.PMode.OT, aPMode.getID (), "no-such-id");
      return EChange.UNCHANGED;
    }
    if (aExistingPMode.isDeleted ())
    {
      AuditHelper.onAuditModifyFailure (com.helger.phase4.model.pmode.PMode.OT, aPMode.getID (), "already-deleted");
      return EChange.UNCHANGED;
    }
    ...
    AuditHelper.onAuditModifySuccess (com.helger.phase4.model.pmode.PMode.OT, "all", aExistingPMode.getID ());
  ...
  public void createOrUpdatePMode (@Nonnull final com.helger.phase4.model.pmode.PMode aPMode)
  {
    ValueEnforcer.notNull (aPMode, "PMode");
    _validatePMode (aPMode);

    // Try in read-lock
    final Predicate <com.helger.phase4.model.pmode.IPMode> aFilter = IPModeManager.getPModeFilter (aPMode.getID (),
                                                                     aPMode.getInitiator (),
                                                                     aPMode.getResponder ());
    com.helger.phase4.model.pmode.IPMode aExisting = findFirst (aFilter);
    if (aExisting == null)
    {
      m_aRWLock.writeLock ().lock ();
      try
  ...
  {
    final com.helger.phase4.model.pmode.PMode aDeletedPMode = getOfID (sPModeID);
    if (aDeletedPMode == null)
    {
      AuditHelper.onAuditDeleteFailure (com.helger.phase4.model.pmode.PMode.OT, "no-such-object-id", sPModeID);
      return EChange.UNCHANGED;
    }
    ...
    try
    {
      ...
      {
        AuditHelper.onAuditDeleteFailure (com.helger.phase4.model.pmode.PMode.OT, "already-deleted", sPModeID);
        return EChange.UNCHANGED;
      }
    ...
    AuditHelper.onAuditDeleteSuccess (com.helger.phase4.model.pmode.PMode.OT, sPModeID);
