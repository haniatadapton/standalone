...
public final class DefaultPMode
{
                                                ...
                                                final boolean bPersist)
  {
    ...
    final com.helger.phase4.model.pmode.PModeParty aInitiator = new com.helger.phase4.model.pmode.PModeParty("default", sInitiatorID, CAS4.DEFAULT_INITIATOR_URL, null, null);
    final com.helger.phase4.model.pmode.PModeParty aResponder = new PModeParty("default", sResponderID, CAS4.DEFAULT_RESPONDER_URL, null, null);
    ...
    final com.helger.phase4.model.pmode.PMode aDefaultPMode = new PMode(sPModeID,
                                           aInitiator,
                                           aResponder,
                                           "urn:as4:agreement",
                                           EMEP.ONE_WAY,
