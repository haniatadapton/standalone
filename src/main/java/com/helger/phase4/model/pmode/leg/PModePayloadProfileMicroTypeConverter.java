...
/**
 * XML converter for objects of class {@link com.helger.phase4.model.pmode.leg.PModePayloadProfile}.
 *
 * @author Philip Helger
 */
public class PModePayloadProfileMicroTypeConverter extends AbstractPModeMicroTypeConverter <com.helger.phase4.model.pmode.leg.PModePayloadProfile>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.model.pmode.leg.PModePayloadProfile aValue,
  ...
  @Nonnull
  public com.helger.phase4.model.pmode.leg.PModePayloadProfile convertToNative (final IMicroElement aElement)
  {
    ...
    final EMandatory eMandatory = EMandatory.valueOf (aElement.getAttributeValueAsBool (ATTR_MANDATORY,
                                                                                        com.helger.phase4.model.pmode.leg.PModePayloadProfile.DEFAULT_MANDATORY));
