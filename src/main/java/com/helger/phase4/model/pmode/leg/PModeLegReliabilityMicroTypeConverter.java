...
/**
 * XML converter for objects of class {@link com.helger.phase4.model.pmode.leg.PModeLegReliability}.
 *
 * @author Philip Helger
 */
public class PModeLegReliabilityMicroTypeConverter extends AbstractPModeMicroTypeConverter <com.helger.phase4.model.pmode.leg.PModeLegReliability>
{
  ...
  @Nonnull
  public IMicroElement convertToMicroElement (@Nonnull final com.helger.phase4.model.pmode.leg.PModeLegReliability aValue,
  ...
  @Nonnull
  public com.helger.phase4.model.pmode.leg.PModeLegReliability convertToNative (@Nonnull final IMicroElement aElement)
  {
    final ETriState eAtLeastOnceContract = getTriState (aElement.getAttributeValue (ATTR_AT_LEAST_ONCE_CONTRACT),
                                                        com.helger.phase4.model.pmode.leg.PModeLegReliability.DEFAULT_AT_LEAST_ONCE_CONTRACT);
    final ETriState eAtLeastOnceAckOnDelivery = getTriState (aElement.getAttributeValue (ATTR_AT_LEAST_ONCE_ACK_ON_DELIVERY),
                                                             com.helger.phase4.model.pmode.leg.PModeLegReliability.DEFAULT_AT_LEAST_ONCE_ACK_ON_DELIVERY);
    ...
    final ETriState eAtLeastOnceContractAckResponse = getTriState (aElement.getAttributeValue (ATTR_AT_LEAST_ONCE_CONTRACT_ACK_RESPONSE),
                                                                   com.helger.phase4.model.pmode.leg.PModeLegReliability.DEFAULT_AT_LEAST_ONCE_CONTRACT_ACK_RESPONSE);
    ...
    final ETriState eAtMostOnceContract = getTriState (aElement.getAttributeValue (ATTR_AT_MOST_ONCE_CONTRACT),
                                                       com.helger.phase4.model.pmode.leg.PModeLegReliability.DEFAULT_AT_MOST_ONCE_CONTRACT);
    final ETriState eInOrderContract = getTriState (aElement.getAttributeValue (ATTR_IN_ORDER_CONTRACT),
                                                    com.helger.phase4.model.pmode.leg.PModeLegReliability.DEFAULT_IN_ORDER_CONTACT);
    final ETriState eStartGroup = getTriState (aElement.getAttributeValue (ATTR_START_GROUP),
                                               com.helger.phase4.model.pmode.leg.PModeLegReliability.DEFAULT_START_GROUP);
    ...
    final ETriState eTerminateGroup = getTriState (aElement.getAttributeValue (ATTR_TERMINATE_GROUP),
                                                   com.helger.phase4.model.pmode.leg.PModeLegReliability.DEFAULT_TERMINATE_GROUP);
