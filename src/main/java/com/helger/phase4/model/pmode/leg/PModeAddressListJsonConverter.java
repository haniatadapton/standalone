...
/**
 * JSON converter for {@link com.helger.phase4.model.pmode.leg.PModeAddressList} objects.
 *
...
public final class PModeAddressListJsonConverter
{
  ...
  @Nonnull
  public static IJsonArray convertToJson (@Nonnull final com.helger.phase4.model.pmode.leg.PModeAddressList aValue)
  {
    return new JsonArray ().addAll (aValue.addresses ());
  }

  @Nonnull
  public static com.helger.phase4.model.pmode.leg.PModeAddressList convertToNative (@Nonnull final IJsonArray aElement)
  {
