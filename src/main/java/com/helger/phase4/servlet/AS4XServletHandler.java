...
public class AS4XServletHandler implements IXServletSimpleHandler
{
  ...
  @Nonnull
  @Override
  public com.helger.phase4.servlet.AS4UnifiedResponse createUnifiedResponse (@Nonnull final EHttpVersion eHTTPVersion,
                                                                             @Nonnull final EHttpMethod eHTTPMethod,
                                                                             @Nonnull final HttpServletRequest aHttpRequest,
                                                                             @Nonnull final IRequestWebScope aRequestScope)
  {
    // Override from base class
    return new com.helger.phase4.servlet.AS4UnifiedResponse(eHTTPVersion, eHTTPMethod, aHttpRequest);
  }
   ...
   * {@link com.helger.phase4.servlet.AS4UnifiedResponse}.
   *
   * @param aHttpResponse
   ...
   */
  @Nonnull
  public static IAS4ResponseAbstraction createResponseAbstraction (@Nonnull final com.helger.phase4.servlet.AS4UnifiedResponse aHttpResponse)
  {
  ...
  protected void handleRequest (@Nonnull final IRequestWebScopeWithoutResponse aRequestScope,
                                @Nonnull final com.helger.phase4.servlet.AS4UnifiedResponse aHttpResponse,
                                   ...
                                   @Nonnull final UnifiedResponse aUnifiedResponse) throws Exception
  {
    ...
    final com.helger.phase4.servlet.AS4UnifiedResponse aRealUnifiedResponse = (AS4UnifiedResponse) aUnifiedResponse;
