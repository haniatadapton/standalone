...
/**
 * Implementation of {@link com.helger.phase4.mgr.IAS4ManagerFactory} creating managers that are
 * persisting to disk.
 *
...
public class AS4ManagerFactoryPersistingFileSystem implements IAS4ManagerFactory
{
  ...
  @Nonnull
  public com.helger.phase4.mgr.IAS4TimestampManager createTimestampManager ()
  {
