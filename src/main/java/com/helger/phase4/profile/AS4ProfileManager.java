...
public class AS4ProfileManager implements IAS4ProfileManager
{
  ...
  @GuardedBy ("m_aRWLock")
  private final ICommonsMap <String, com.helger.phase4.profile.IAS4Profile> m_aProfiles = new CommonsTreeMap <> ();
  ...
  @Nonnull
  @ReturnsMutableCopy
  public ICommonsList <com.helger.phase4.profile.IAS4Profile> getAllProfiles ()
  {
  ...
  @Nullable
  public com.helger.phase4.profile.IAS4Profile getProfileOfID (@Nullable final String sID)
  {
