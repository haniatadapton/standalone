...
/**
 * phase4 crypto factory settings based on {@link com.helger.phase4.crypto.AS4CryptoProperties}
 *
...
public class AS4CryptoFactoryProperties extends AbstractAS4CryptoFactory
{
  ...
  private static final AS4CryptoFactoryProperties DEFAULT_INSTANCE = new AS4CryptoFactoryProperties (com.helger.phase4.crypto.AS4CryptoProperties.createFromConfig ());
  ...
  private final com.helger.phase4.crypto.AS4CryptoProperties m_aCryptoProps;
  // Lazy initialized
   ...
   */
  public AS4CryptoFactoryProperties (@Nonnull final com.helger.phase4.crypto.AS4CryptoProperties aCryptoProps)
  {
  ...
  public final com.helger.phase4.crypto.AS4CryptoProperties cryptoProperties ()
  {
   ...
   */
  @Nonnull
  public static Crypto createCrypto (@Nonnull final com.helger.phase4.crypto.AS4CryptoProperties aCryptoProps)
  {
    ValueEnforcer.notNull (aCryptoProps, "CryptoProps");
    try
    {
   ...
   */
  @Nonnull
  public static com.helger.phase4.crypto.AS4CryptoProperties readCryptoPropertiesFromFile (@Nullable final String sCryptoPropertiesPath)
  {
    com.helger.phase4.crypto.AS4CryptoProperties aCryptoProps;
    if (StringHelper.hasNoText (sCryptoPropertiesPath))
    {
      // Uses crypto.properties => needs exact name crypto.properties
      aCryptoProps = new com.helger.phase4.crypto.AS4CryptoProperties(new ClassPathResource ("private-crypto.properties"));
      ...
      {
        aCryptoProps = new com.helger.phase4.crypto.AS4CryptoProperties(new ClassPathResource ("crypto.properties"));
        if (aCryptoProps.isRead ())
        {
