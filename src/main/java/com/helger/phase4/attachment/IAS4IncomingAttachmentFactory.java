...
/**
 * Factory interface for {@link com.helger.phase4.attachment.WSS4JAttachment} objects for handling incoming
 * attachments.
 *
...
public interface IAS4IncomingAttachmentFactory
{
   ...
   */
  @Nonnull
  com.helger.phase4.attachment.WSS4JAttachment createAttachment (@Nonnull MimeBodyPart aBodyPart, @Nonnull AS4ResourceHelper aResHelper)
                                                                                                            throws IOException,
                                                                                                            MessagingException;

  /**
   * The default instance of {@link IAS4IncomingAttachmentFactory} that uses
   * {@link com.helger.phase4.attachment.WSS4JAttachment#createIncomingFileAttachment(MimeBodyPart, AS4ResourceHelper)}
   */
  @Nonnull
