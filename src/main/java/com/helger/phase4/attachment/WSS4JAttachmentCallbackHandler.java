...
public class WSS4JAttachmentCallbackHandler implements CallbackHandler
{
  ...
  private final ICommonsOrderedMap <String, com.helger.phase4.attachment.WSS4JAttachment> m_aAttachmentMap = new CommonsLinkedHashMap <> ();
  private final AS4ResourceHelper m_aResHelper;

  public WSS4JAttachmentCallbackHandler (@Nullable final Iterable <? extends com.helger.phase4.attachment.WSS4JAttachment> aSrcAttachments,
                                         @Nonnull @WillNotClose final AS4ResourceHelper aResHelper)
  {
    ValueEnforcer.notNull (aResHelper, "ResHelper");

    if (aSrcAttachments != null)
      for (final com.helger.phase4.attachment.WSS4JAttachment aAttachment : aSrcAttachments)
      {
  ...
  private ICommonsList <Attachment> _getAttachmentsToAdd (@Nullable final String sAttachmentID)
  {
    ...
    final com.helger.phase4.attachment.WSS4JAttachment aAttachment = m_aAttachmentMap.get (sAttachmentID);
    if (aAttachment != null)
    ...
    for (final Callback aCallback : aCallbacks)
    {
      if (aCallback instanceof AttachmentRequestCallback)
      {
        ...
        if (aCallback instanceof AttachmentResultCallback)
        {
          ...
          // Source attachment
          final com.helger.phase4.attachment.WSS4JAttachment aSrcAttachment = m_aAttachmentMap.get (sAttachmentID);
          ...
          // Convert
          final com.helger.phase4.attachment.WSS4JAttachment aEffectiveResultAttachment = new com.helger.phase4.attachment.WSS4JAttachment(m_aResHelper,
  ...
  @Nonnull
  @ReturnsMutableCopy
  public ICommonsList <com.helger.phase4.attachment.WSS4JAttachment> getAllResponseAttachments ()
  {
